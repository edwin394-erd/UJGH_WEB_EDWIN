        ...
        <div class="md:w-1/2 p-10 border bg-white rounded-2xl mt-10 md:mt-0 mx-8">
            <form action={{route('register')}} method="POST" novalidate>
                ...
                <div class="m-5">
                    ...
                    <input id="titulo" name="titulo" type="text" placeholder="Titulo de la publicación" class="shadow-lg border p-3 w-full rounded-lg @error('name') border-red-500 @enderror" value="{{old('name')}}">
                    @error('titulo')
                ...
                <div class="m-5">
                    ...
                    <textarea id="descripcion" name="descripcion" type="text" placeholder="Descripción de la publicación" class="shadow-lg border p-3 w-full rounded-lg @error('name') border-red-500 @enderror">{{old('name')}}</textarea>
                    @error('descripcion')
                        <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center">{{$message}}</p>
                    @enderror
                </div>
